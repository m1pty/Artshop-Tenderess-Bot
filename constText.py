...
admin_menu = """
Добро пожаловать в меню разработчика!
Доступные команды:
...
balance = "💸 Ваш баланс: "
inventory = "🎒 Приобретённые услуги и товары: "
...
piar12p =  f"Вы уверены, что хотите приобрести пиар на 12 часов за {constPrices.allprices['piar_12_p']} тенд.?"
piar12s =  f"Вы уверены, что хотите приобрести пиар на 12 часов для шопа за {constPrices.allprices['piar_12_s']} тенд.?"
piar24p =  f"Вы уверены, что хотите приобрести пиар на 24 часа за {constPrices.allprices['piar_24_p']} тенд.?"
piar24s =  f"Вы уверены, что хотите приобрести пиар на 24 часа для шопа за {constPrices.allprices['piar_24_s']} тенд.?"
contestp = f"Вы уверены, что хотите приобрести выставление конкурса за {constPrices.allprices['contest_p']} тенд.?"
contests = f"Вы уверены, что хотите приобрести выставление конкурса для шопа за {constPrices.allprices['contest_s']} тенд.?"

#ПРИОБРЕТЕНИЕ

buying =  "Поздравляем с приобретением!\n\n"
buying1 = ", поздравляем! Выбитые предметы:\n\n"
buying2 = "⭐️ *Для получения товара свяжитесь с нашим администратором* с подтверждением в виде скрина и пересланного сообщения.\n\n"
admin =   "👤 *Администратор:* <...>"
...
art_banner_items = "Доступные предметы баннера художников: "
tess_banner_items = "Доступные предметы баннера Тесс: "